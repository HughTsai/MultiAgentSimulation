...
import nju.simulation.experiment4.AgentWorldSimpleTest;

public class Main4 {

	private static final double ASSETUPPER = 5000;//C值的上限
	private static final double ASSETLOWER = 0;//C值的下限
	private static final double ASSETINCREMENT = 10;//C值的增量
	private static final int APPOINTEDAGENT = 0;//指定的agent
